...
- The user-provided Jun 5 market is stale. The latest relevant active Hong Kong highest-temperature market is Jun 7, while Jun 6 is effectively a near-resolution reference.
- Polymarket resolves against HKO's finalized "Absolute Daily Max (deg. C)" in the Daily Extract, measured to one decimal place, so the HK Observatory station is the settlement anchor.
- HKO's 20:45 local forecast for tonight and tomorrow is 25-30°C with occasional showers, squally thunderstorms, and heavy showers at times.
- HKO's 19:50 9-day forecast gives Jun 7 a maximum of 30°C, minimum of 25°C, high rain probability, 80-95% relative humidity, and southwest force 4 winds.
- Weather.com also shows Jun 7 at 30°C with thunderstorms and high rain odds, supporting the HKO rain-capped 30°C base case.
- Timeanddate and AccuWeather are warmer for airport/Sha Tin-style locations, which keeps 31-32°C+ alive as upside risk, but those are not the official HKO settlement station.
...
- The Jun 7 market is thinner than the mature Jun 6 market, so the edge depends on actual executable prices.
...
- Timeanddate Hong Kong 14-day and hourly forecast: https://www.timeanddate.com/weather/hong-kong/hong-kong/ext and https://www.timeanddate.com/weather/hong-kong/hong-kong/hourly
- AccuWeather Hong Kong/Sha Tin 10-day forecast: https://www.accuweather.com/en/hk/hong-kong/1123655/10-day-weather-forecast/1123655
